...
public class DBApp {
    ...
    public DBApp(String appName) { // DBApp constructor (initialization)
        Page.MAX_TUPLES = MAXIMUM_ROWS_COUNT_IN_PAGE; // set the maximum number of tuples (rows) in a page
    ...
    private void createTableMetadata(String strTableName, Hashtable<String, String> htblColNameType, String strClusteringKeyColumn,
        ...
        writer.println(" Page maximum row count is, " + MAXIMUM_ROWS_COUNT_IN_PAGE); // write the maximum number of rows in a page
